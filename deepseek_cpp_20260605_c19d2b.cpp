//File 0341 : xframe/xdimension.hpp
//Dimension class: a named axis with a coordinate, metadata, and SIMD‑accelerated label lookup for 2D/3D simulation.
...
namespace xframe
{
    /**
     * @class dimension
     * @brief A named axis with a coordinate array and optional unit/description.
     *
    ...
    public:
        ...
        /**
         * Construct a dimension with a name and size (generates integer labels 0..size-1).
         */
