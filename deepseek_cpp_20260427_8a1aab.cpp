// File 224: modules/newton/src/bodies/newton_body.h (update)
// Updated NewtonBody with collision shape storage, material ID, CCD flag,
// and methods to support world interactions (get_collision_shape, get_material_id, etc.)

#ifndef NEWTON_BODIES_NEWTON_BODY_H
#define NEWTON_BODIES_NEWTON_BODY_H
...
class NewtonBody : public RefCounted {
	GDCLASS(NewtonBody, RefCounted);
...
public:
	...
	// Update inverse inertias after rotation changes.
	...
	// --- Collision shape ---
	void set_collision_shape(const Ref<NewtonCollision> &p_shape);
	Ref<NewtonCollision> get_collision_shape() const { return collision_shape; }
	...
	// --- CCD ---
	void set_ccd_enabled(bool p_enable) { ccd_enabled = p_enable; }
...
private:
	...
	mat3 inertia_local;           // in local frame
...
#endif // NEWTON_BODIES_NEWTON_BODY_H