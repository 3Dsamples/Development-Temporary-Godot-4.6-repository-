...
// File : scene/3d/gpu_particles_3d_ext.h 13 of 60
// Description : Extended GPU particles node with emission parameters, collisions,
//               trails, shadow and GI support, and full RenderingServer sync.
#pragma once

#include "scene/3d/gpu_particles_3d.h"
#include "servers/rendering_server.h"

class GPUParticles3DExt : public GPUParticles3D {
    GDCLASS(GPUParticles3DExt, GPUParticles3D);
...
public:
    ...
    // ------------------------------------------------------------------------
    // Lighting & shadows (particles can cast shadows)
    // ------------------------------------------------------------------------
